...
main :-
    ...
    C3 = [X \= c],
    mk_push_pop(C1,C2,C3),
    nl,
    C4 = [X = (s(a))],
    C5 = [forall(var(Y), X \= (s(Y)))],              
    C6 = [X \= c],
    mk_push_pop(C4,C5,C6),
    nl,
    C7 = [X \= (s(a))],
    C8 = [X = (s(Y))], 
    C9 = [X \= c],
    mk_push_pop(C7,C8,C9),
    nl,
    C10 = [X \= (s(a))],
    C11 = [forall(var(Y), X \= (s(Y)))],              
    C12 = [X = c],
    mk_push_pop(C10,C11,C12),
    nl,
    C13 = [X = (s(a))],
    C14 = [X = (s(Y))],
    C15 = [X \= c],
    mk_push_pop(C13,C14,C15),
    nl,
    C16 = [X = (s(a))],
    C17 = [forall(var(Y), X \= (s(Y)))],                     
    C18 = [X = c],
    mk_push_pop(C16,C17,C18),
    nl,
    C19 = [X \= (s(a))],
    C20 = [X = (s(Y))],
    C21 = [X = c],
    mk_push_pop(C19,C20,C21),
    nl,
    C22 = [X = (s(a))],
    C23 = [X = (s(Y))],                        
    C24 = [X = c],
    mk_push_pop(C22,C23,C24).
